(() => {
  ...
  $('#startOsteoporosis').addEventListener('click',()=>{ $('#osteoporosisForm').reset(); renderIdentity('osteoporosisIdentity',savedPerson('osteoporosis')); $('#osteoporosisWeight').value=(state.osteoporosis||{}).weight??''; $('#osteoporosisResult').hidden=true; error('#osteoporosisError',''); showStep(11); });
